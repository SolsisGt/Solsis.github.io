...
<body>
	...
	<div class="slide">
		<figure>
			...
			<span class="i3"><img src="img/i3.png" alt=""></span>
		...
		<main class="inicio" id="inicio">
			<h1>Inicio</h1>
			<img src="./img/solsis.png" src="logo" alt="">
			<div>
	...
	<footer>
		<div class="container">
			<div class="row ">
				<div class="col-sm-4  d-flex flex-column align-items-start p-md-3">
				...
				<div class="col-sm-4  d-flex flex-column align-items-center p-md-3">
